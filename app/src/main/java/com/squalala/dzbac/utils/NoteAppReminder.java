...
public class NoteAppReminder {
    ...
    public NoteAppReminder(Context context, MainPreferences mainPreferences) {
        this.context = context;
        this.mainPreferences = mainPreferences;
    }


    public void checkMomentNoteApp(final Tracker tracker) {
        ...
        if (mainPreferences.getNoteAppValue() == 100 || mainPreferences.getNoteAppValue() == 500) {
            ...
            new SweetAlertDialog(context, SweetAlertDialog.CUSTOM_IMAGE_TYPE)
                    ...
                    .setCustomImage(R.drawable.ic_mood_black_24dp)
                    ...
                    .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                        ...
                        public void onClick(SweetAlertDialog sDialog) {
                            ...
                            new SweetAlertDialog(context, SweetAlertDialog.CUSTOM_IMAGE_TYPE)
                                    ...
                                    .setCustomImage(R.drawable.ic_play_shopping_bag_grey600_24dp)
