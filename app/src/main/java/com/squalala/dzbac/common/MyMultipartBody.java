...
public final class MyMultipartBody extends ProgressRequestBody {
    /**
    ...
    MyMultipartBody(ByteString boundary, MediaType type, List<Part> parts, File file, UploadCallbacks mListener) {
   ...
   /* @Override public void writeTo(BufferedSink sink) throws IOException {
    ...
    public static final class Builder {
        ...
        public Builder setUploadCallbacksListener(UploadCallbacks listener) {
            mListener = listener;
            return this;
        }
        ...
        public MyMultipartBody build() {
            ...
            return new MyMultipartBody(boundary, type, parts, file, mListener);
        }
    }
}